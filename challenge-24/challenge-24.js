(function(win, doc) {
    ...
    */
    ...
    var operations = {
        '+': function(firstValue, lastValue) { return firstValue + lastValue },
        '-': function(firstValue, lastValue) { return firstValue - lastValue },
        'x': function(firstValue, lastValue) { return firstValue * lastValue },
        '÷': function(firstValue, lastValue) { return firstValue / lastValue }
    };
    ...
    function doOperation(operator, firstValue, lastValue) {
        return operations[operator](firstValue, lastValue);
    }
