(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Filipe Leuch Bonfim'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'curitibano'));
    ...
    */
    ...
    console.log('O mês de [NOME DO MÊS] é representado pelo número [NÚMERO DO MÊS].'.replace(/\[NOME DO MÊS\]/, 'dezembro').replace(/\[NÚMERO DO MÊS\]/, getMonthNumber('dezembro')));
