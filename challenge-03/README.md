...
*/
pessoa.nomeCompleto() // "Filipe Leuch Bonfim"
...
pessoa.apresetacao = function() {
	var nomeArtigoSexo = (this.sexo === 'Feminino') ? 'a' : 'o';
  ...
  + " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + " " + nomeQtdMetros + "!";
}

// Agora, apresente-se ;)
pessoa.apresetacao()
// "Olá, eu sou o Filipe Leuch Bonfim, tenho 32 anos, 1.7, meu peso é 72 e, só hoje, eu já caminhei 6 metros!"
