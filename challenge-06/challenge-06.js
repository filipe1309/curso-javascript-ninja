...
desafio.
*/
var teams = ['Coritiba', 'Operario', 'Londrina', 'Parana Clube', 'Athletico Paranaense'];
...
*/
console.log(showTeamPosition(1)); // O time que está em 1º lugar é o Coritiba.
console.log(showTeamPosition(3)); // O time que está em 3º lugar é o Londrina.
console.log(showTeamPosition(5)); // O time que está em 5º lugar é o Athletico Paranaense.
