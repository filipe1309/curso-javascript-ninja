(function() {
    ...
    */
    ...
    var fullName = 'filipe-leuch-bonfim';
    console.log(fullName);
    console.log(fullName.split('-').map(function(item) { return item.charAt(0).toUpperCase() + item.slice(1); }).join(' '));
    ...
    */
    ...
    var myName = 'Filipe';
    console.log(myName.split('').map(function(item, index) { return (index % 2 ? item.toLowerCase() : item.toUpperCase()); }).join(''));
