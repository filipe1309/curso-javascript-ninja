(function() {
  ...
  */
  ...
  var result = sum(function(num1, num2) {
    return num1 + num2;
  });
  ...
  */
  ...
  var result = subtraction(function(num1, num2) {
    return num1 - num2;
  });
  console.log(result); // -1

  console.log( 'O resultado da multiplicação é:' );
  var result = multiplication(function(num1, num2) {
    return num1 * num2;
  });
  console.log(result); // 42

  console.log( 'O resultado da divisão é:' );
  var result = division(function(num1, num2) {
    return num1 / num2;
  });
  console.log(result); // 4

  console.log( 'O resto da divisão é:' );
  var result = mod(function(num1, num2) {
    return num1 % num2;
  });
  console.log(result); // 1
